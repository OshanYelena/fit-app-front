...
import { createMessage } from "../actions/instructor";
import auth from "../reducers/auth";
import "./main.css";

const MessageForm = ({ userData, createMessage, isAuthenticated }) => {
        ...
        <div className="card grid-margin">
          <div className="card-body">
            ...
            {form ? (
              ...
              <>
                <button onClick={() => setForm(true)}>Create a message</button>
              </>
            )}
          </div>
          {form && userData ? (
